    ...
    public class ServiceService : IServiceService
    {
        ...
        private List<Service> InitializeServiceData()
        {
            return new List<Service>
            {
                ...
                new Service { Id = 2, Name = "Skin Fade / Bald Fade", Description = "Ultra-short fade cut down to the skin for a sharp, clean look", Price = "R180", DurationMinutes = 50, Category = ServiceCategory.HairServicesMen, IsPopular = true, ImageUrl = "/images/services/skin-fade.jpg", SortOrder = 2 },
                new Service { Id = 3, Name = "Low / Mid / High Fade", Description = "Professional fade cuts at varying heights to suit your style preference", Price = "R160", DurationMinutes = 45, Category = ServiceCategory.HairServicesMen, IsPopular = true, ImageUrl = "/images/services/fade-variations.jpg", SortOrder = 3 },
                new Service { Id = 4, Name = "Afro Cut & Shape", Description = "Specialized cutting and shaping for natural African hair textures", Price = "R140", DurationMinutes = 40, Category = ServiceCategory.HairServicesMen, IsPopular = false, ImageUrl = "/images/services/afro-cut.jpg", SortOrder = 4 },
                new Service { Id = 5, Name = "Waves Maintenance & Cut", Description = "Professional wave pattern maintenance with precision cutting", Price = "R170", DurationMinutes = 50, Category = ServiceCategory.HairServicesMen, IsPopular = false, ImageUrl = "/images/services/waves-maintenance.jpg", SortOrder = 5 },
                new Service { Id = 6, Name = "Beard Trim & Line-Up", Description = "Professional beard trimming with clean line-up for a polished look", Price = "R100", DurationMinutes = 30, Category = ServiceCategory.HairServicesMen, IsPopular = true, ImageUrl = "/images/services/beard-trim.jpg", SortOrder = 6 },
                ...
                new Service { Id = 8, Name = "Hairline Enhancement", Description = "Precision hairline cleanup and enhancement for a fresh appearance", Price = "R80", DurationMinutes = 25, Category = ServiceCategory.HairServicesMen, IsPopular = false, ImageUrl = "/images/services/hairline-enhancement.jpg", SortOrder = 8 },
                ...
                new Service { Id = 11, Name = "Hair Dye for Men", Description = "Professional hair coloring services for men", Price = "R250", DurationMinutes = 75, Category = ServiceCategory.HairServicesMen, IsPopular = false, ImageUrl = "/images/services/hair-dye-men.jpg", SortOrder = 11 },
                new Service { Id = 12, Name = "Cornrows / Braiding (Men)", Description = "Traditional cornrow braiding and protective styling for men", Price = "R180", DurationMinutes = 120, Category = ServiceCategory.HairServicesMen, IsPopular = false, ImageUrl = "/images/services/cornrows-men.jpg", SortOrder = 12 },

                // Hair Services - Women
                new Service { Id = 13, Name = "Wash, Blow & Style", Description = "Professional wash, blow-dry and styling service", Price = "R120", DurationMinutes = 60, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/wash-blow-style.jpg", SortOrder = 1 },
                new Service { Id = 14, Name = "Silk Press", Description = "Heat styling for smooth, silky straight hair with natural movement", Price = "R280", DurationMinutes = 90, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/silk-press.jpg", SortOrder = 2 },
                new Service { Id = 15, Name = "Hair Relaxing", Description = "Chemical relaxing treatment for permanently straightened hair", Price = "R320", DurationMinutes = 120, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/hair-relaxing.jpg", SortOrder = 3 },
                new Service { Id = 16, Name = "Cornrows / Feed-in Braids", Description = "Protective braiding styles including feed-in techniques", Price = "R250", DurationMinutes = 180, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/cornrows-feedin.jpg", SortOrder = 4 },
                new Service { Id = 17, Name = "Box Braids / Knotless Braids", Description = "Long-lasting protective box braids and knotless variations", Price = "R450", DurationMinutes = 300, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/box-braids.jpg", SortOrder = 5 },
                new Service { Id = 18, Name = "Twist Styles", Description = "Two-strand twists, Marley twists and other protective twist styles", Price = "R300", DurationMinutes = 240, Category = ServiceCategory.HairServicesWomen, IsPopular = false, ImageUrl = "/images/services/twist-styles.jpg", SortOrder = 6 },
                new Service { Id = 19, Name = "Frontal / Closure Wig Install", Description = "Professional wig installation with frontal or closure pieces", Price = "R400", DurationMinutes = 180, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/wig-install.jpg", SortOrder = 7 },
                new Service { Id = 20, Name = "Weave Install", Description = "Professional hair weave installation service", Price = "R350", DurationMinutes = 150, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/weave-install.jpg", SortOrder = 8 },
                new Service { Id = 21, Name = "Wig Revamp / Styling", Description = "Wig restoration, restyling and customization service", Price = "R180", DurationMinutes = 90, Category = ServiceCategory.HairServicesWomen, IsPopular = false, ImageUrl = "/images/services/wig-revamp.jpg", SortOrder = 9 },
                new Service { Id = 22, Name = "Colouring & Highlights", Description = "Professional hair coloring and highlight services", Price = "R380", DurationMinutes = 150, Category = ServiceCategory.HairServicesWomen, IsPopular = true, ImageUrl = "/images/services/coloring-highlights.jpg", SortOrder = 10 },
                new Service { Id = 23, Name = "Hair Treatment / Repair Mask", Description = "Deep conditioning and repair treatment for damaged hair", Price = "R200", DurationMinutes = 60, Category = ServiceCategory.HairServicesWomen, IsPopular = false, ImageUrl = "/images/services/hair-treatment-women.jpg", SortOrder = 11 },
                new Service { Id = 24, Name = "Trim & Straighten", Description = "Hair trimming with straightening service", Price = "R150", DurationMinutes = 75, Category = ServiceCategory.HairServicesWomen, IsPopular = false, ImageUrl = "/images/services/trim-straighten.jpg", SortOrder = 12 },
